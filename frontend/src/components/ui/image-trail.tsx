...
const DEFAULT_IMAGES: ImageTrailImage[] = [
  ...
  {
    src: "https://images.unsplash.com/photo-1550684846-fac1c5b4e853?auto=format&fit=crop&w=480&q=80",
    alt: "Creative technology texture",
  },
  {
...
export function ImageTrail({
  ...
  return (
    ...
    >
      ...
      <div className={cn("pointer-events-none absolute inset-0 z-[5] overflow-hidden", overlayClassName)}>
        <AnimatePresence>
          {trail.map((item) => (
            <motion.div
              key={item.id}
